...
public class ExcelHandler {
    ...
    //Get excel Workbook - from file location
    ...
    //Get entire column and option to skip first row for headings
    ...
    //Get entire row and option to skip first row for headings
    ...
    //Get particular cell data(combination of column and row)

...
import com.Pages.Reports_QueriesRprtPage;

public class Reports_QueriesRprtTest extends OpenAndCloseBrowser{
	...
	public void selectStudyDropdown(String studyName) throws Exception{
		Reports_QueriesRprtPage QR=new Reports_QueriesRprtPage(driver);
		QR.clickSelectStudyDropdown(studyName);
		Thread.sleep(1000);
	}

...
import com.Pages.Reports_sdsPage;

public class Reports_sdsTest extends OpenAndCloseBrowser{
	...
	public void selectStudyDropdown(String studyName) throws Exception{
		Reports_sdsPage SDSR=new Reports_sdsPage(driver);
		SDSR.clickSelectStudyDropdown(studyName);
		Thread.sleep(1000);
	}
	...
	public void documentMGMT() throws InterruptedException, IOException{
		...
		SDSR.openSDS();
		Thread.sleep(500);
		//SDSR.generateReports();
		SDSR.downloadReports();
	}

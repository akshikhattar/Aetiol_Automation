...
import com.Pages.Reports_AFSRPage;

public class Reports_AFSRTest extends OpenAndCloseBrowser{
	...
	public void selectStudyDropdown(String studyName) throws Exception{
		Reports_AFSRPage AFSR=new Reports_AFSRPage(driver);
		AFSR.clickSelectStudyDropdown(studyName);
		Thread.sleep(1000);
	}
	...
	public void documentMGMT() throws InterruptedException, IOException{
		...
		AFSR.openAFSR();
		Thread.sleep(500);
		AFSR.generateReports();
		AFSR.downloadReports();
	}

...
import com.Pages.Reports_AMDRPage;

public class Reports_AMDRTest extends OpenAndCloseBrowser{
	...
	public void selectStudyDropdown(String studyName) throws Exception{
		Reports_AMDRPage AMDR=new Reports_AMDRPage(driver);
		AMDR.clickSelectStudyDropdown(studyName);
		Thread.sleep(1000);
	}
	...
	public void documentMGMT() throws InterruptedException, IOException{
		...
		AMDR.openAMDR();
		Thread.sleep(1000);
		AMDR.generateReports();
		AMDR.downloadReports();
	}
